...
{
    char *name;
    UInt32 flags;      /* flags for file system operations */
    ...
    int (*read)     (struct dfs_fd *fd, void *buf, UInt32 count);
    int (*write)    (struct dfs_fd *fd, const void *buf, UInt32 count);
    int (*flush)    (struct dfs_fd *fd);
    int (*lseek)    (struct dfs_fd *fd, Int32 offset);
    int (*getdents) (struct dfs_fd *fd, struct dirent *dirp, UInt32 count);
...
Int32 dfs_filesystem_get_partition(struct dfs_partition *part,
                                      UInt8           *buf,
                                      UInt32           pindex);
