...
static UInt8 mmcsd_stack[RT_MMCSD_STACK_SIZE];
static struct rt_mailbox  mmcsd_detect_mb;
static UInt32 mmcsd_detect_mb_pool[4];
...
Int32 mmcsd_send_cmd(struct rt_mmcsd_host *host,
...
Int32 mmcsd_spi_read_ocr(struct rt_mmcsd_host *host,
                              Int32            high_capacity,
                              UInt32          *ocr)
{
    struct rt_mmcsd_cmd cmd;
...
static Int32 _mmcsd_select_card(struct rt_mmcsd_host *host,
...
Int32 mmcsd_deselect_cards(struct rt_mmcsd_card *card)
{
...
{
    rt_mb_send(&mmcsd_detect_mb, (UInt32)host);
}
