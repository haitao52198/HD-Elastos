...
/* export API. */
extern Int32 rt_hw_wifi_init(const char *spi_device_name,wifi_mode_t mode);
extern int32_t rw009_rssi(void);
extern Int32 rw009_join(const char * SSID, const char * passwd);
extern Int32 rw009_softap(const char * SSID, const char * passwd,uint32_t security,uint32_t channel);
