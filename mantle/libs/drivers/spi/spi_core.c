...
extern Int32 rt_spi_bus_device_init(struct rt_spi_bus *bus, const char *name);
extern Int32 rt_spidev_device_init(struct rt_spi_device *dev, const char *name);
                                  ...
                                  void                 *user_data)
{
    ...
    if (bus != NULL && bus->type == RT_Device_Class_SPIBUS)
    {
