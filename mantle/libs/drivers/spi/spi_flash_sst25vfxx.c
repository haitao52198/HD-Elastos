...
static Int32 sst25vfxx_flash_init(rt_device_t dev)
{
    return RT_EOK;
}

static Int32 sst25vfxx_flash_open(rt_device_t dev, UInt16 oflag)
{
    Int32 result;
...
static Int32 sst25vfxx_flash_close(rt_device_t dev)
{
    return RT_EOK;
}

static Int32 sst25vfxx_flash_control(rt_device_t dev, UInt8 cmd, void *args)
{
...
static UInt32 sst25vfxx_flash_read(rt_device_t dev, Int32 pos, void* buffer, UInt32 size)
{
    Int32 result;
...
static UInt32 sst25vfxx_flash_write(rt_device_t dev, Int32 pos, const void* buffer, UInt32 size)
{
    uint32_t i;
    Int32 result;
...
Int32 sst25vfxx_init(const char * flash_device_name, const char * spi_device_name)
{
    ...
    /* no private */
    spi_flash->flash_device.user_data = NULL;
