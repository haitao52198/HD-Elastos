...
struct rt_uart_ops
{
    Int32 (*configure)(struct rt_serial_device *serial, struct serial_configure *cfg);
    Int32 (*control)(struct rt_serial_device *serial, int cmd, void *arg);

    int (*putc)(struct rt_serial_device *serial, char c);
    int (*getc)(struct rt_serial_device *serial);

    UInt32 (*dma_transmit)(struct rt_serial_device *serial, const UInt8 *buf, UInt32 size, int direction);
};
