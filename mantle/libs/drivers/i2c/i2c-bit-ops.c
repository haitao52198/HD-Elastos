...
#define bit_dbg(fmt, ...)   printf(fmt, ##__VA_ARGS__)
#else
#define bit_dbg(fmt, ...)
#endif
 ...
 */
static Int32 SCL_H(struct rt_i2c_bit_ops *ops)
{
    rt_tick_t start;
...
static Int32 i2c_writeb(struct rt_i2c_bus_device *bus, UInt8 data)
{
    Int32 i;
    UInt8 bit;
...
static Int32 i2c_readb(struct rt_i2c_bus_device *bus)
{
    UInt8 i;
    UInt8 data = 0;
    struct rt_i2c_bit_ops *ops = bus->priv;
...
static UInt32 i2c_send_bytes(struct rt_i2c_bus_device *bus,
                                struct rt_i2c_msg        *msg)
{
    ...
    Int32 count = msg->len;
    UInt16 ignore_nack = msg->flags & RT_I2C_IGNORE_NACK;
...
static Int32 i2c_send_ack_or_nack(struct rt_i2c_bus_device *bus, int ack)
{
    struct rt_i2c_bit_ops *ops = bus->priv;
...
static UInt32 i2c_recv_bytes(struct rt_i2c_bus_device *bus,
                                struct rt_i2c_msg        *msg)
{
    Int32 val;
    Int32 bytes = 0;   /* actual bytes */
    UInt8 *ptr = msg->buf;
    Int32 count = msg->len;
...
static Int32 i2c_send_address(struct rt_i2c_bus_device *bus,
                                   UInt8                addr,
                                   Int32                retries)
{
    struct rt_i2c_bit_ops *ops = bus->priv;
...
static Int32 i2c_bit_send_address(struct rt_i2c_bus_device *bus,
                                     struct rt_i2c_msg        *msg)
{
...
static UInt32 i2c_bit_xfer(struct rt_i2c_bus_device *bus,
